...
//[Id], [UserName], [UserPassword], [FirstName], [LastName], [CreatedDate], [ModifiedDate], [Active]
 ...
 async function Create(param){
     ...
     return new Promise((resolve,reject)=>{
      ...
      // Use the connection
        connection.query(`CALL ${sp.MyThesaurusCreate}(1,'${param.MyWord}','${param.MyWordMeaning}','${param.MyWordTamilMean}',${param.MyThesaurusCategory},'na',${param.MyThesaurusMap});`, function (error, results, fields) {
...
async function Single(param){
    ...
    return new Promise((resolve,reject)=>{
      ...
      // Use the connection
        connection.query(`CALL ${sp.MyThesaurusSingle}(${param.Id});`, function (error, results, fields) {
        // When done with the connection, release it.
        connection.release();
